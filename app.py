...
def main():
    ...
    h_dd_slider = st.sidebar.slider(r'$h_{dd}\,(\mathrm{meV})$', -250.0, 250.0, st.session_state['h_dd'])
    h_dd_input = st.sidebar.number_input(r'$h_{dd}\,(\mathrm{meV})$', min_value=-250.0, max_value=250.0, value=h_dd_slider)
    
    h_uu_slider = st.sidebar.slider(r'$h_{uu}\,(\mathrm{meV})$', -250.0, 250.0, st.session_state['h_uu'])
    h_uu_input = st.sidebar.number_input(r'$h_{uu}\,(\mathrm{meV})$', min_value=-250.0, max_value=250.0, value=h_uu_slider)
    
    h_ud_slider = st.sidebar.slider(r'$h_{ud}\,(\mathrm{meV})$', -250.0, 250.0, st.session_state['h_ud'])
    h_ud_input = st.sidebar.number_input(r'$h_{ud}\,(\mathrm{meV})$', min_value=-250.0, max_value=250.0, value=h_ud_slider)
    
    mud_slider = st.sidebar.slider(r'$\mu^0_\mathrm{d}\,(\mathrm{meV):$', -250.0, 250.0, st.session_state['mud'])
    mud_input = st.sidebar.number_input(r'$\mu^0_\mathrm{d}\,(\mathrm{meV):$', min_value=-250.0, max_value=250.0, value=mud_slider)
    
    muu_slider = st.sidebar.slider(r'$\mu^0_\mathrm{u}\,(\mathrm{meV):$', -250.0, 250.0, st.session_state['muu'])
    muu_input = st.sidebar.number_input(r'$\mu^0_\mathrm{u}\,(\mathrm{meV):$', min_value=-250.0, max_value=250.0, value=muu_slider)
    
    T_slider = st.sidebar.slider(r'$T\,(\mathrm{K})$', 200.0, 500.0, 300.0)
    T_input = st.sidebar.number_input(r'$T\,(\mathrm{K})$', min_value=200.0, max_value=500.0, value=T_slider)
